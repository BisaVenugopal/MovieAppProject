...
const HorizontalScrollCard = ({data = [], heading, trending, media_type}) => {
 ...
 <div ref={containerRef} className='grid grid-cols-[repeat(auto-fit,230px)] overflow-hidden grid-flow-col gap-6 overflow-x-scroll  relative z-10 scroll-smooth transition-all scrollbar-none  '>
  {
    data.map((data,index)=>{
        return(
